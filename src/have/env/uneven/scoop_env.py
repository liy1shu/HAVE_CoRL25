...
class ScoopEnv(gym.Env):
    def __init__(self,
                 ...
                 delta_track_path = "/home/yishu/HAVE_release/src/have/utils/DELTA",
                 delta_ckpt_path = "/home/yishu/HAVE_release/src/have/utils/DELTA/checkpoints/densetrack3d.pth",
                 ):
        ...
        self.tracker = Tracker(self.camera, delta_track_path, delta_ckpt_path)
        ...
        # self.init_video_writer('/home/yishu/HAVE_release/assets/debug.mp4')
    ...
    def step_action(self, action, record, writer = None):
        ...
        for _ in range(self.ikMaxNumIterations*2):
            ...
            # plt.imsave('/home/yishu/HAVE_release/debug.png', self.render()["rgb"])
            # breakpoint()
    ...
    def check_lifted(self, steady_threshold=0.01, lift_threshold=0.015):
        ...
        is_lifted = is_steady and base_position[2] > lift_threshold + self.rodPosition[2]
