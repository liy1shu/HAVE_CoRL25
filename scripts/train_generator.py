...
def main(cfg):
    ...
    if 'door' in cfg.dataset.name:  # multimodal-door dataset
        ...
        fully_closed_datamodule = data_module_class[cfg.dataset.task](
            ...
            seed=cfg.seed,
            history="his" in cfg.generator.name,
            randomize_size=cfg.dataset.randomize_size,
            augmentation=cfg.dataset.augmentation,
    ...
    network = PN2DiT(
        ...
        depth=cfg.generator.depth,
        hidden_size=cfg.generator.hidden_size,
        patch_size=cfg.generator.patch_size,
        num_heads=cfg.generator.num_heads,
    ...
    model = training_module_class(
        network, training_cfg=cfg.training, model_cfg=cfg.generator
    )
        ...
        callbacks=[
            ...
            LogPredictionSamplesCallback(
                ...
                eval_dataloader_lengths=[
                    len(val_loader),
                    # len(multimodal_loader) if "his" in cfg.generator.name else len(unseen_loader),
